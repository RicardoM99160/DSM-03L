    ...
    private void inicializar() {
        ...
        listaPersonas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("peso",String.valueOf(personas.get(i).getPeso()));
                intent.putExtra("altura",String.valueOf(personas.get(i).getAltura()));
                intent.putExtra("fechaN",personas.get(i).getFechaNacimiento());
